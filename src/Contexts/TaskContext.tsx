...
interface TaskContextTpe {
    columns: Column[];
    addTask: (ColumnId: string, task: Task) => void;
    updateTask: (ColumnId: string, taskId: string, updatedTask: Task) => void;
    deleteTask: (columnId: string, targetColumnId: string, taskId: string) => void;
}


export const TaskContext = createContext<TaskContextTpe | undefined>()undefined;
...
export const TasksProvider: React.FC<TasksProviderProps> = ({ children }) => {
    ...
    const moveTask = (sourceColumn: string, targetColumnId: string, taskId: string) => {
